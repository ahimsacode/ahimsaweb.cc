...
On 29 November, 2020 I decided to touch up my developer skills and began working through the course materials on [freeCodeCamp](https://freecodecamp.org). This pages was created to track my progress through the course materials. I've also created [a blog](https://ahimsacode.github.io) (as a means of learning to use the Jackyl framework within GitHub Pages) where I am logging my process.
...
##- [x] Basic CSS (completed 2020-12-02)##
...
##- [x] Applied Visual Design (completed 2020-12-03)##
...
##- [x] Applied Accessability (completed 2020-12-03)##
...
##- [x] Responsive Web Design Principles (completed 2020-12-04)##
...
##- [x] CSS Flexbox (completed 2020-12-04)##
	- [x] Use display: flex to Position Two Boxes (completed 2020-12-04)
	- [x] Add Flex Superpowers to the Tweet Embed (completed 2020-12-04)</label>
...
##- [x] CSS Grid (completed 2020-12-04)##
...
##- [ ] Responsive Web Design Projects (in progress)##
	- [x] [Build a Tribute Page](https://ahimsaweb.cc/fcc/01-01-tribute-page/) (completed 2020-12-05)
				[Build a Survey Form]()
